  ...
  return (
    <div className="legal-section-title">
      <h1 className="legal-siteTitle">
        <Link to="/">
          Design thinking <span className="legal-siteSign">project</span>
        </Link>
      </h1>
      ...
      <div className="legal-text-content">
        ...
        <p className="legal-description">
          Welcome to Design thinking project , your trusted online healthcare
        ...
        <p className="legal-description">
          When using Design thinking project , you agree to our Terms of
          Service. This includes guidelines for using our platform, interacting
          with doctors, and the responsibilities of both parties. It's essential
        ...
        <p className="legal-description">
          Design thinking project is designed to simplify healthcare access. You
